...
const initializer = () => {
  ...
  for (let i = 0; i < 29; i++) {
    ...
    // Unicode values for Arabic letters
    button.innerText = String.fromCharCode(1601 + i);
    // character button click
    button.addEventListener("click", () => {
      let charArray = chosenWord.split("");
      let dashes = document.getElementsByClassName("dashes");
      // if the array contains clicked value replace the matched dash with a letter else draw on the canvas
